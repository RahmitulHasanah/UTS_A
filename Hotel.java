...
public class Hotel {
    ...
    Scanner masuktotal=new Scanner (System.in);
        ...
        System.out.println("WELCOME TO HASANAH HOTEL");
        System.out.println();
        ...
        switch (room){
            ...
            System.out.println();
                    ...
                    System.out.println("================Rahmitul Hasanah================");
                    break;
            case 2: System.out.println("Anda akan memesan kamar 2");
            System.out.println();
                    System.out.print("Silahkan Masukkan Berapa Hari anda akan tinggal = ");
                    waktu = masuktotal.nextInt();
                    tarif = waktu*700000;
                    System.out.println("Harga = Rp."+tarif+",-");
                    if(waktu>=4){
